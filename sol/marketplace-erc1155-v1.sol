...
contract MarketplaceErc1155 is AccessControl {
    string public version = "0.1.0";
    address private marketOwner;
    uint256 public listingPrice = 5;
    ...
    enum Action { RESERVED, STARTED }

    event SellEvent ( address _seller, address _token, uint256 _offerId, uint256 _tokenId, uint256 _amount );
    event CanceledSell ( address _seller, address _token, uint256 _tokenId, uint256 _amountOfToken );
    event BuyEvent ( address _buyer, address _token, uint256 _tokenId, uint256 _amountOfToken, uint256 _price );
    ...
    **/
    ...
    /**
        ...
        @param _endAt This is the final date in (seconds) so the offer ends.
    ...
    **/
    function createList(
        ...
        */
        ...
        require(_endAt > 3600, "The endAt needs to be greater than 1 hour");

        /*
            Add variables to the SellList struct with tokenAddress, seller, tokenId, amountOfToken, endAt, price
        */
    ...
    **/
    function buyListToken(
        ...
        */
        ...
        /*
            Get salePrice and feePrice from the listingPrice
        */
        uint256 salePrice = sales[_sellId].price;
        uint256 feePrice = salePrice * listingPrice / 100;
    ...
    **/
    function acceptOffer(
        ...
        */
        ...
        /*
            Get offerPrice and feePrice from the listingPrice
        */
        uint256 offerPrice = offer.offerPrice;
        uint256 feePrice = offerPrice * listingPrice / 100;
    ...
    **/
    ...
    /**
        ...
        @param _startAt This is the start date in (seconds) so the auction starts.
    ...
    **/
    function createAuction(
        ...
        */
        ...
        require(_duration > 86400, "createAuction: The endAt should to be greater than 1 day");
        ...
        require(_startAt > block.timestamp, "createAuction: The start date should be after now");
    ...
    */
    function placeBid(
        ...
        */
        ...
        /*
            Check if bidAmount is bigger than the higestBid + minIncrement
                ...
                if the bidTime is after the startAt
        */
        ...
        require(block.timestamp >= auctionInfo.startAt, "placeBid: Bid should be after the startAt");
        require(auctionInfo.action == Action.RESERVED || auctionInfo.startAt + auctionInfo.duration > block.timestamp, "placeBid: It is Ended");
        ...
        */
        ...
        /*
            If the auction is reserved, set the startAt as now
            action as Action Enum - STARTED
        */
        if (auctionInfo.action == Action.RESERVED) {
            auction[_auctionId].startAt = block.timestamp;
    ...
    */
    function cancelAuction(
        ...
        */
        ...
        require(block.timestamp > auctionInfo.startAt + auctionInfo.duration, "cancelAuction: The time should be after endDate");
    ...
    */
    function claimAuction(
        ...
        */
        ...
        require(block.timestamp > auctionInfo.startAt + auctionInfo.duration, "claimAuction: The time should be after endDate");
        ...
        */
        ...
        /*
            Get bidPrice and feePrice from the listingPrice
        */
        uint256 bidPrice = auctionInfo.highestBid;
        uint256 feePrice = bidPrice * listingPrice / 100;
