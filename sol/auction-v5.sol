...
contract AuctionMarket {
    ...
    // market function
    //////////////////////////////
    function setAuctionOwner(address _newOwner) external  {
    ...
    // external function
    //////////////////////////////
    function addAuctionItem(address _nft, uint256 _tokenId, uint256 _startAt, uint256 _endAt, uint256 _startBid) external payable {
